...
> See the [Wiki](https://github.com/Papaskas/strict-store/wiki/globals) for detailed usage, types, and advanced examples.
...
Full API documentation is available in the [GitHub Wiki](https://github.com/Papaskas/strict-store/wiki/globals).
